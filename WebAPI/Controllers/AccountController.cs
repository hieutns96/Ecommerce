...
namespace WebAPI.Controllers
{
   // [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public  Task SendAsync(string userid,string des,string sub,string body)
        {
            //plug in your Email Service here to send an email
            MailMessage msg = new MailMessage("doctorstrange1206@gmail.com", des, sub, body);
            msg.IsBodyHtml = true;
            ...
            using (SmtpClient client = new SmtpClient())
            {
                ...
                client.Send(msg);
                client.SendMailAsync("doctorstrange1206@gmail.com", des, sub, body);
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            else
            {
                ...
                await SendAsync(msgUserId,user.Email, msgSubject, msgBody);
                Console.Write("di den day ne");
                return Ok();
            }
